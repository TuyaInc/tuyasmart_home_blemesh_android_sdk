...
public class BlueMeshGroupListPresenter implements IMeshGroupListPresenter {
    ...
    public BlueMeshGroupListPresenter(Activity context, IMeshGroupListView view, long homeId, String meshId) {
    ...
    private void createMeshGroup(String groupName) {
        //检查群组是否已满
    ...
    private String getEnableGroupId(String meshId) {
