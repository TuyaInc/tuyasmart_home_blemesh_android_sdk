...
public class BlueMeshGroupDeviceListPresenter extends BasePresenter implements IMeshGroupDeviceListPresenter {
    ...
    public BlueMeshGroupDeviceListPresenter(MeshGroupDevListActivity activity, IMeshGroupDeviceListView view) {
        mActivity = activity;
        mView = view;
