...
public class SigMeshGroupDeviceListPresenter extends BasePresenter implements IMeshGroupDeviceListPresenter {
    private static final String TAG = "SigMeshGroupDeviceListPresenter";
    ...
    public SigMeshGroupDeviceListPresenter(MeshGroupDevListActivity activity, IMeshGroupDeviceListView view) {
        mActivity = activity;
        mView = view;
    ...
    private void getData() {
        ...
        mTuyaBlueMeshDevice=TuyaHomeSdk.newSigMeshDeviceInstance(mMeshId);

        //mesh设备
        groupBean = TuyaHomeSdk.getDataInstance().getGroupBean(mGroupId);

        if (groupBean != null) {
            mGroup=TuyaHomeSdk.newSigMeshGroupInstance(mGroupId);
...
//            }
    ...
    private void removeDeviceToMeshGroup(final DeviceBean bean) {
    ...
    private void addDeviceToMeshGroup(final DeviceBean groupDevice) {
    ...
    private void showOperateFaileDialog(final ArrayList<DeviceBean> failList, final int subOperateCount) {
