...
public class BlueMeshControlPresenter implements IControlPresenter {
    private static final String TAG = "BlueMeshControlPresenter";
    ...
    public BlueMeshControlPresenter(Context context, String devId, IControlView view) {
