...
public class MeshControlActivity extends AppCompatActivity implements CompoundButton.OnCheckedChangeListener, RadioGroup.OnCheckedChangeListener, SeekBar.OnSeekBarChangeListener ,IControlView {
    ...
    protected void sendRGBCommand(int r, int g, int b) {
    ...
    public void sendCommand(String command) {
        ...
        mControlPresenter.sendDps(command, new IResultCallback() {
            ...
            public void onError(String s, String s1) {
                Toast.makeText(MeshControlActivity.this, "contral fail " + s + "  " + s1, Toast.LENGTH_SHORT).show();
            }
