...
import com.smart.tuya.meshdemo.activity.MeshControlActivity;
 ...
 * @date 2019-07-18.
 */
public class BlueMeshListPresenter implements IMeshListPresenter {

    private static final String TAG = "BlueMeshListPresenter";
    ...
    public BlueMeshListPresenter(Activity context, IMeshDeviceListView view, long homeId, String meshId) {
    ...
    private void showLightControlActivity(DeviceBean deviceBean, String devId) {
        ...
        if (vendorId.endsWith("01")) {
            intent = new Intent(mContext, MeshControlActivity.class);
